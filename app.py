...
upscaler4x = StableDiffusionUpscalePipeline.from_pretrained(model_4x, torch_dtype=torch.float16) if torch.cuda.is_available() else StableDiffusionUpscalePipeline.from_pretrained(model_4x)
